...
module.exports.condition = (currentToken, index, tokens, stack) => currentToken.is(TYPE.operator, "bool");
...
module.exports.result = (currentTokens, index, tokens, offset, amount, stack) => {
    let n = toBool(currentTokens[1]); if (n?.type === TYPE.error) return [[n], stack];
