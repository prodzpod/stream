...
const { transformIfType, toBool, toNumber } = require("../bsEvalUtil");

// int
module.exports.priority = 20;
// (Token, int, [Token], StackData) => bool
module.exports.condition = (currentToken, index, tokens, stack) => currentToken.is(TYPE.operator, "number");
...
module.exports.result = (currentTokens, index, tokens, offset, amount, stack) => {
    let n = toNumber(currentTokens[1]); if (n?.type === TYPE.error) return [[n], stack];
