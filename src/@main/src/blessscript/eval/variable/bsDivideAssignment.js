...
module.exports.result = async (currentTokens, index, tokens, offset, amount, stack) => {
    ...
    let res = require("../arithmetic/bsDivide").result([unbox([currentTokens[0]], stack)[0], currentTokens[1], unbox([currentTokens[2]], stack)[0]], index, tokens, offset, amount, stack);
