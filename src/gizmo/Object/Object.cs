...
namespace ProdModel.Object
{
    public class Object
    {
        ...
        public Object Listen() { return this; /* disabled */ LastWSSent = new(); WebSocket = new("ws://localhost:339/gizmo/" + Name, ws => {}, OnWSRecieve); return this; }
        ...
        public virtual void OnUpdate(GameTime gameTime)
        {
            ...
            if (WebSocket != null && Lifetime - LastWSSend > 0.1f) {
                ...
                if (_txt != "")
                {
                    ...
                    // ProdModel.Log("Sending: " +  _txt);
                    WebSocket.Send("update", _txt);
                }
                LastWSSend = Lifetime;
                WSSendForce = false;
            }
