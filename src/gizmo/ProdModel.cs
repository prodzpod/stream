...
namespace ProdModel
{
    public class ProdModel : Game
    {
        ...
        protected override void Initialize()
        {
            ...
            WebSocket = new("ws://localhost:339/gizmo", ws => { ws.Send("init"); }, Server.HandleData);
            Audio.Init();
        ...
        protected override void LoadContent()
        {
            ...
            var theme = new Object.Object("_subject")
                .AddChild(new NineSliceSprite("Content/layout/making", true, false))
                .AddChild(new TextSprite("arcaoblique", "\"loading...\"").SetAlign(-1, 0), 138 - 14, 0)
