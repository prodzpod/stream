...
namespace NotGMS.Util
{
    public static class EaseP
    {
        ...
        public static Func<float, float, float, float> Flicker() => (a, b, t) => MathP.Chance(t, false) ? b : a;
        public static Func<float, float, float, float> InFlicker() => (a, b, t) => MathP.Chance(t, false) ? MathP.Lerp(a, b, t) : a;
        public static Func<float, float, float, float> OutFlicker() => (a, b, t) => MathP.Chance(t, false) ? b : MathP.Lerp(a, b, t);
