    ...
    public class Fetch : Command
    {
        public override object?[]? Execute(params object?[] args)
        {
            ...
            return subject switch
            {
                ...
                "chatcount" => [Game.INSTANCES.Where(x => x.Element is Elements.Gizmos.Chat).Count()],
                "pointercount" => [Game.INSTANCES.Where(x => x.Element is Pointer).Count()],
                _ => ["invalid subject"],
            };
        }
    }
