...
const { STREAMER_ID, CLONK_ID, MALPHON_ID, LALA_ID, FORREST_ID, ELLG_ID, BUG_ID, NILBOG_ID, GOB_ID, KINSKY_ID, TYUMICI_ID } = require("../common");
...
const EVENTS = [
    ...
    */
    "clonk.chat.message", "malphon.chat.message", "lala.chat.message", "forrest.chat.message", "tyumici.chat.message", "kinsky.chat.message", // "nilbog.chat.message", "gob.chat.message", "ellg.chat.message", "bug.chat.message", /* "malphon.channel_points_custom_reward_redemption.add" */
];
...
const type = {
    ...
    "tyumici.chat.message": "channel.chat.message",
...
const condition = {
    ...
    "tyumici.chat.message": { broadcaster_user_id: TYUMICI_ID, user_id: STREAMER_ID },
